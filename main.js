              ...
              e(),
                ...
                (() => {
                  const t = document.querySelector("#inbox"),
                    i = document.querySelector("#today"),
                    a = document.querySelector("#this-week"),
                    u = document.querySelector("#add-project-div"),
                    c = document.querySelector("#add-project-input"),
                    l = document.querySelector("#add-project"),
                    f = document.querySelector("#add-project-btn"),
                    s = document.querySelector("#cancel-project-btn"),
                    p = document.querySelectorAll(".x-project");
                  t.addEventListener("click", () => {
                    ...
                    l.addEventListener("click", (t) => {
                      (u.style.display = "flex"), (l.style.display = "none");
                    }),
                    s.addEventListener("click", (t) => {
                      (u.style.display = "none"), (l.style.display = "flex");
                    }),
                    f.addEventListener("click", (t) => {
                      tt.addProject(c.value), o();
                    }),
                    p.forEach((t) => {
                      t.addEventListener("click", (t) => {
