      ...
      const bt = (t, e) => {
          ...
          if (((r.textContent = "Inbox"), n.appendChild(r), null != e))
            for (let t = 0; t < e.length; t++) {
              ...
              a.setAttribute("value", e[t].title), (a.type = "text");
